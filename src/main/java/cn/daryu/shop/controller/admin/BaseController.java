...
public class BaseController
{
    ...
    {
        webdatabinder.registerCustomEditor(java/lang/String, new StringTrimmerEditor(true));
    ...
    protected void IIIllIlI(String s)
    {
        if(s != null)
        {
            RequestAttributes requestattributes = RequestContextHolder.currentRequestAttributes();
            requestattributes.setAttribute(Log.LOG_CONTENT_ATTRIBUTE_NAME, s, 0);
        }
    }
